...
export const en: Dictionary = {
  ...
  cookies: {
    bannerText:
      "We use cookies for essential website functionality, analytics and improving ads. You can change your consent at any time.",
    rejectOptional: "Reject optional",
    settings: "Settings",
    acceptAll: "Accept all",
    bannerAriaLabel: "Cookie consent",
    modalTitle: "Cookie settings",
    modalIntro: "Choose which cookies we may use. Necessary cookies are always on.",
    save: "Save settings",
    close: "Close",
    alwaysOn: "Always on",
    necessaryTitle: "Necessary cookies",
    necessaryText: "Required for basic website functionality and saving your cookie choice.",
    analyticsTitle: "Analytics cookies",
    analyticsText: "Help us understand how visitors use the website so we can improve it.",
    marketingTitle: "Marketing cookies",
    marketingText: "Help us measure ad performance and show more relevant ads.",
